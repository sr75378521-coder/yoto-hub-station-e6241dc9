...
export const YOTO_SCOPES = "openid profile offline_access family:library:view family:library:manage family:devices:view family:devices:manage family:devices:control user:content:view user:content:manage";
